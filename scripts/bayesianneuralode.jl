...
savefig(plotsdir("neuralode/learningcurve.png"))
...
xlabel!(phase_plt, "prey")
ylabel!(phase_plt, "predator")

savefig(plt, plotsdir("neuralode/SGLD_LV35_12.png"))
savefig(phase_plt, plotsdir("neuralode/SGLD_LV_phase35_12.png"))